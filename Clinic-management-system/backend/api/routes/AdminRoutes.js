...
import { getAllUsers, updateUserStatus, createDoctor, getAllPendingUsers, getAllDoctorsForAdmin } from '../controllers/AdminController.js';
...
router.get('/getalldoctors', protect, authorize(UserRole.ADMIN), getAllDoctorsForAdmin);
